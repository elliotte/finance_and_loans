...
describe ReportsDashService do
    ...
    context "returning UKGAAP structured data" do
        ...
        it 'report should have monea-tagged values' do
            ...
            expect(monea_tags).to eq  ["No-Mapping", "Plant & machinery cost - additions", "Plant & machinery cost - disposals", "Trade debtors", "Trade creditors", "Other taxes and social security costs", "Sales", "Advertising and PR", "Directors' salaries", "Purchases", "Commissions payable", "Wages and salaries", "Rent", "Light and heat", "Travel and subsistence", "Accountancy fees", "Cleaning", "Staff training and welfare", "Insurance"]
        end
        it 'should have 58 report values' do
        ...
        it 'can group cy values' do
          ...
          expect(a).to eq([{:lv_1=>"Trade creditors", :lv_2=>"No-Mapping", :amount=>1537.7852659}, {:lv_1=>"Directors' salaries", :lv_2=>"op_admin", :amount=>162.32356431}, {:lv_1=>"Rent", :lv_2=>"op_admin", :amount=>11721.56085}, {:lv_1=>"Sales", :lv_2=>"gp_sales", :amount=>107133.0812437}, {:lv_1=>"Wages and salaries", :lv_2=>"op_admin", :amount=>16836.737607}, {:lv_1=>"No-Mapping", :lv_2=>"No-Mapping", :amount=>111404.75909555}, {:lv_1=>"Commissions payable", :lv_2=>"gp_cos", :amount=>11769.227235}, {:lv_1=>"Light and heat", :lv_2=>"op_admin", :amount=>7236.2600098}, {:lv_1=>"Purchases", :lv_2=>"gp_cos", :amount=>7225.1342608}, {:lv_1=>"Cleaning", :lv_2=>"op_admin", :amount=>16545.125247}, {:lv_1=>"Travel and subsistence", :lv_2=>"op_admin", :amount=>44169.1894101}, {:lv_1=>"Accountancy fees", :lv_2=>"op_admin", :amount=>12024.06662785}, {:lv_1=>"Other taxes and social security costs", :lv_2=>"No-Mapping", :amount=>36657.75420059}, {:lv_1=>"Staff training and welfare", :lv_2=>"op_admin", :amount=>22873.603575}, {:lv_1=>"Insurance", :lv_2=>"op_admin", :amount=>19513.3573129}, {:lv_1=>"Trade debtors", :lv_2=>"No-Mapping", :amount=>3893.0114682}, {:lv_1=>"Advertising and PR", :lv_2=>"op_admin", :amount=>9410.851151}, {:lv_1=>"Plant & machinery cost - disposals", :lv_2=>"No-Mapping", :amount=>18369.215613}, {:lv_1=>"Plant & machinery cost - additions", :lv_2=>"No-Mapping", :amount=>15146.3380142}])
        end
        it 'can group py values' do
          a = gaap_dash_s.group_py
          expect(a).to eq([{:lv_1=>"Trade creditors", :lv_2=>"No-Mapping", :amount=>3383.2230561}, {:lv_1=>"Directors' salaries", :lv_2=>"op_admin", :amount=>3023.7033456}, {:lv_1=>"Rent", :lv_2=>"op_admin", :amount=>9365.759973}, {:lv_1=>"Sales", :lv_2=>"gp_sales", :amount=>59870.73483561}, {:lv_1=>"Wages and salaries", :lv_2=>"op_admin", :amount=>11100.23686}, {:lv_1=>"No-Mapping", :lv_2=>"No-Mapping", :amount=>133087.210104425}, {:lv_1=>"Commissions payable", :lv_2=>"gp_cos", :amount=>18831.763192}, {:lv_1=>"Light and heat", :lv_2=>"op_admin", :amount=>3111.3833781}, {:lv_1=>"Purchases", :lv_2=>"gp_cos", :amount=>17288.806038}, {:lv_1=>"Cleaning", :lv_2=>"op_admin", :amount=>25587.0059203}, {:lv_1=>"Travel and subsistence", :lv_2=>"op_admin", :amount=>-10452.91763237}, {:lv_1=>"Accountancy fees", :lv_2=>"op_admin", :amount=>23029.371804}, {:lv_1=>"Other taxes and social security costs", :lv_2=>"No-Mapping", :amount=>48268.2359684}, {:lv_1=>"Staff training and welfare", :lv_2=>"op_admin", :amount=>-1081.2654074}, {:lv_1=>"Insurance", :lv_2=>"op_admin", :amount=>-28746.048115}, {:lv_1=>"Trade debtors", :lv_2=>"No-Mapping", :amount=>13503.395736}, {:lv_1=>"Advertising and PR", :lv_2=>"op_admin", :amount=>16976.956521}, {:lv_1=>"Plant & machinery cost - disposals", :lv_2=>"No-Mapping", :amount=>2772.922263}, {:lv_1=>"Plant & machinery cost - additions", :lv_2=>"No-Mapping", :amount=>12214.454106}])
        end
        it 'can return summarise data' do
          a = gaap_dash_s.load_data
          expect(a).to eq({:cy=>[{:lv_1=>"Trade creditors", :lv_2=>"No-Mapping", :amount=>1537.7852659}, {:lv_1=>"Directors' salaries", :lv_2=>"op_admin", :amount=>162.32356431}, {:lv_1=>"Rent", :lv_2=>"op_admin", :amount=>11721.56085}, {:lv_1=>"Sales", :lv_2=>"gp_sales", :amount=>107133.0812437}, {:lv_1=>"Wages and salaries", :lv_2=>"op_admin", :amount=>16836.737607}, {:lv_1=>"No-Mapping", :lv_2=>"No-Mapping", :amount=>111404.75909555}, {:lv_1=>"Commissions payable", :lv_2=>"gp_cos", :amount=>11769.227235}, {:lv_1=>"Light and heat", :lv_2=>"op_admin", :amount=>7236.2600098}, {:lv_1=>"Purchases", :lv_2=>"gp_cos", :amount=>7225.1342608}, {:lv_1=>"Cleaning", :lv_2=>"op_admin", :amount=>16545.125247}, {:lv_1=>"Travel and subsistence", :lv_2=>"op_admin", :amount=>44169.1894101}, {:lv_1=>"Accountancy fees", :lv_2=>"op_admin", :amount=>12024.06662785}, {:lv_1=>"Other taxes and social security costs", :lv_2=>"No-Mapping", :amount=>36657.75420059}, {:lv_1=>"Staff training and welfare", :lv_2=>"op_admin", :amount=>22873.603575}, {:lv_1=>"Insurance", :lv_2=>"op_admin", :amount=>19513.3573129}, {:lv_1=>"Trade debtors", :lv_2=>"No-Mapping", :amount=>3893.0114682}, {:lv_1=>"Advertising and PR", :lv_2=>"op_admin", :amount=>9410.851151}, {:lv_1=>"Plant & machinery cost - disposals", :lv_2=>"No-Mapping", :amount=>18369.215613}, {:lv_1=>"Plant & machinery cost - additions", :lv_2=>"No-Mapping", :amount=>15146.3380142}], :py=>[{:lv_1=>"Trade creditors", :lv_2=>"No-Mapping", :amount=>3383.2230561}, {:lv_1=>"Directors' salaries", :lv_2=>"op_admin", :amount=>3023.7033456}, {:lv_1=>"Rent", :lv_2=>"op_admin", :amount=>9365.759973}, {:lv_1=>"Sales", :lv_2=>"gp_sales", :amount=>59870.73483561}, {:lv_1=>"Wages and salaries", :lv_2=>"op_admin", :amount=>11100.23686}, {:lv_1=>"No-Mapping", :lv_2=>"No-Mapping", :amount=>133087.210104425}, {:lv_1=>"Commissions payable", :lv_2=>"gp_cos", :amount=>18831.763192}, {:lv_1=>"Light and heat", :lv_2=>"op_admin", :amount=>3111.3833781}, {:lv_1=>"Purchases", :lv_2=>"gp_cos", :amount=>17288.806038}, {:lv_1=>"Cleaning", :lv_2=>"op_admin", :amount=>25587.0059203}, {:lv_1=>"Travel and subsistence", :lv_2=>"op_admin", :amount=>-10452.91763237}, {:lv_1=>"Accountancy fees", :lv_2=>"op_admin", :amount=>23029.371804}, {:lv_1=>"Other taxes and social security costs", :lv_2=>"No-Mapping", :amount=>48268.2359684}, {:lv_1=>"Staff training and welfare", :lv_2=>"op_admin", :amount=>-1081.2654074}, {:lv_1=>"Insurance", :lv_2=>"op_admin", :amount=>-28746.048115}, {:lv_1=>"Trade debtors", :lv_2=>"No-Mapping", :amount=>13503.395736}, {:lv_1=>"Advertising and PR", :lv_2=>"op_admin", :amount=>16976.956521}, {:lv_1=>"Plant & machinery cost - disposals", :lv_2=>"No-Mapping", :amount=>2772.922263}, {:lv_1=>"Plant & machinery cost - additions", :lv_2=>"No-Mapping", :amount=>12214.454106}]})
        end
    end
